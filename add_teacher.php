                        ...
                        <!-- content starts here -->
                            ...
                            <form method="post" enctype="multipart/form-data" class="form-horizontal form-label-left">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="email" name="address" id="last-name2" class="form-control col-md-7 col-xs-12" required="required">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
									<label class="control-label col-md-4" for="last-name">College Stream <span class="required" style="color:red;">*</span>
									</label>
									<div class="col-md-4">
                                ...
                                <div class="form-group">
    <label class="control-label col-md-4" for="first-name">Section <span class="required" style="color:red;">*</span></label>
    <div class="col-md-3">
                        ...
                        <!---        <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                                        <a href="teacher.php"><button type="button" class="btn btn-primary"><i class="fa fa-times-circle-o"></i> Cancel</button></a>
		...
		//							$profile=$_FILES["image"]["name"];
					...
					$result=mysqli_query($con,"select * from teacher1 WHERE school_number='$school_number' ") or die (mysqli_error());
					$row=mysqli_num_rows($result);
					if ($row > 0)
					{
					echo "<script>alert('ID Number already active!'); window.location='teacher.php'</script>";
					}
					else
					{		
						mysqli_query($con,"insert into teacher1 (school_number,firstname, middlename, lastname, contact, gender, address, type, level, section, status, user_added)
						...
						echo "<script>alert('User successfully added!'); window.location='teacher.php'</script>";
					}
			//						}
			//						}
							}
