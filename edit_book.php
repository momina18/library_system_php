...
mysqli_query($con," UPDATE book SET book_title='$book_title', category_id='$category_id', author='$author', isbn='$isbn', status='$status', remarks='$remark' WHERE book_id = '$id' ")or die(mysqli_error());
